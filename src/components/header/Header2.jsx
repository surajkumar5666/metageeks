                  ...
                  <ul>
                    <li className="single-contact">
                      ...
                      <div className="contact">
                        <span>Phone</span>
                        <h6>
                          <a href="tel:+918860382254">+91 - 8860382254</a>
                        </h6>
                      </div>
                    </li>
                    <li className="single-contact">
        ...
        <div className="container d-flex flex-nowrap align-items-center justify-content-between">
          ...
          <div className="nav-right d-flex jsutify-content-end align-items-center">
            <div className="right-sidebar-and-hotline-area">
              <div className="hotline-area bg-white d-xl-flex d-none">
                <div className="icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={22}
                ...
                <div className="content">
                  ...
                  <h6>
                    <Link href="tel:+918860382254">+91 - 8860382254</Link>
                  </h6>
                </div>
              </div>
              <div
                ...
                className="sidebar-btn px-3 bg-primary"
